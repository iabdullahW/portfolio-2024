...
const Footer = () => {
  return (
    React.createElement("div", { className: "text-self flex items-center gap-x-4" },
      ...
      React.createElement(Link, { href: socialMediaLinks['kaggle'], target: "_blank", className: "pt-6 hover:text-white duration-150 ease-in-out flex items-center" },
        "kaggle",
        React.createElement(GoArrowUpRight, { size: 20 })
      ),
      React.createElement(Link, { href: socialMediaLinks['instagram'], target: "_blank", className: "pt-6 hover:text-white duration-150 ease-in-out flex items-center" },
        "instagram",
        React.createElement(GoArrowUpRight, { size: 20 })
      )
    )
